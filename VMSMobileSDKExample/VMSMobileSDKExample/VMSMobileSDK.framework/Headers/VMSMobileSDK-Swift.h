...
#ifndef VMSMOBILESDK_SWIFT_H
#define VMSMOBILESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VMSMobileSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP12VMSMobileSDK26AuthRequestBuilderProtocol_")
...
SWIFT_PROTOCOL("_TtP12VMSMobileSDK10Authorizer_")
@protocol Authorizer
...
SWIFT_CLASS("_TtC12VMSMobileSDK13PusherChannel")
...
SWIFT_CLASS("_TtC12VMSMobileSDK13GlobalChannel")
...
SWIFT_CLASS("_TtC12VMSMobileSDK12OCAuthMethod")
...
SWIFT_CLASS("_TtC12VMSMobileSDK12OCPusherHost")
...
SWIFT_CLASS("_TtC12VMSMobileSDK6Pusher")
...
@interface Pusher (SWIFT_EXTENSION(VMSMobileSDK))
...
SWIFT_CLASS("_TtC12VMSMobileSDK10PusherAuth")
...
SWIFT_CLASS("_TtC12VMSMobileSDK14PusherChannels")
...
SWIFT_CLASS("_TtC12VMSMobileSDK19PusherClientOptions")
...
@interface PusherClientOptions (SWIFT_EXTENSION(VMSMobileSDK))
...
SWIFT_CLASS("_TtC12VMSMobileSDK16PusherConnection")
...
@interface PusherConnection (SWIFT_EXTENSION(VMSMobileSDK))
...
SWIFT_PROTOCOL("_TtP12VMSMobileSDK14PusherDelegate_")
@protocol PusherDelegate
@optional
...
- (void)subscribedToChannelNoDataInPayloadWithName:(NSString * _Nonnull)name;
...
SWIFT_CLASS("_TtC12VMSMobileSDK11PusherError")
...
SWIFT_CLASS("_TtC12VMSMobileSDK21PusherPresenceChannel")
...
SWIFT_CLASS("_TtC12VMSMobileSDK27PusherPresenceChannelMember")
...
SWIFT_CLASS("_TtC12VMSMobileSDK19VMSPlayerController")
@interface VMSPlayerController : UIViewController
- (void)viewDidLoad;
...
@interface VMSPlayerController (SWIFT_EXTENSION(VMSMobileSDK)) <UIScrollViewDelegate>
...
@interface VMSPlayerController (SWIFT_EXTENSION(VMSMobileSDK)) <UIPickerViewDataSource, UIPickerViewDelegate>
